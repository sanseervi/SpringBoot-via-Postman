# SpringBoot
End to End application, performing CRUD operation through postman.
...
## Usage 
Run the project through the IDE and head out to postman [http://localhost:8080](http://localhost:8080)
